...
class MilestoneThreeInverted(Scenario):
    """Straight towards the roundabout, avoid the kamikaze, then enter and drive a bit"""

    waypoints = [
        carla.Location(42.6482, -7.84391, 1.8431),
        carla.Location(22, -4, 1.8431),
        carla.Location(9, -22, 1.8431),
    ]

    def setup(self):
        spawn_point = carla.Transform(location=carla.Location(42.5959, -4.3443, 1.8431),  rotation=carla.Rotation(yaw=180.856))
